# quiz-generator
A Python-based Intelligent Quiz Generator that randomly selects questions, evaluates user answers using keyword matching, and visualizes quiz performance using Matplotlib.

# Intelligent Quiz Generator (Python)
